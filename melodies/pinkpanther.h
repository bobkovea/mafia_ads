...
static constexpr uint16_t Tempo = 1650;
#undef N
...
const Note melody[] PROGMEM =
{
  ...
  N(D5, H), N(REST, Q), N(REST, E), */
  N(DS4, E), N(E4, DQ), N(REST, E), N(FS4, E), N(G4, DQ), N(REST, E), N(DS4, E),
  N(E4, DE), N(FS4, E), N(G4, DE), N(C5, E), N(B4, DE), N(E4, E), N(G4, DE), N(B4, E),

  N(AS4, DH), N(A4, DS), N(G4, DS), N(E4, DS), N(D4, DS),
  N(E4, DQ), N(REST, Q),
